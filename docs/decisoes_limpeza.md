...
- Os 7 ZIPs brutos do PNI (`raw/pni/ano=2025/*.zip`, ~18,5GB no total) foram
  apagados do MinIO depois de limpos com sucesso na camada trusted, para
  liberar disco no ambiente (o Codespace ficou com só 1,7GB livres de 32GB).
  Não é perda de dado: os parquets limpos continuam em `trusted`, e os ZIPs
  originais podem ser rebaixados a qualquer momento com
  `python -m src.ingestion.download_pni --ano 2025`, direto do OpenDataSUS.
